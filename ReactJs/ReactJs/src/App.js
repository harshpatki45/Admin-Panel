...
import AnalyticalReport from "./pages/AnalyticalReport";
...
function App() {
  ...
  <>    <RouteScrollToTop />
      <Routes>
        ...
        <Route exact path='/manage-broadcast' element={<ManageBroadcast />} />
        <Route exact path='/deleted-users' element={<DeletedUsers />} />
        <Route exact path='/table-report' element={<TabularReport />} />
        <Route exact path='/analysis-report' element={<AnalyticalReport />} />
