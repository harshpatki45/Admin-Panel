...
const POLICY_API = "http://localhost:3001/2025/butler_hospitality/server/webservice/get-content-by-id?&content_id=11&content_type=1"

const PricacyPolicyContent = () => {
  ...
  const fetchPolicy = async () => {
    ...
    try {
      ...
      console.log("Response Policy", response.data)
...
export default PricacyPolicyContent;
